...
// Safely serialise static-only data for JSON-LD: escape </script> sequences
// so the parser cannot break out of the script tag.
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" className={`${bebasNeue.variable} ${plusJakarta.variable}`}>
      <head>
        {/* JSON-LD: all data is static const — safeJsonLd escapes closing-tag sequences */}
