  ...
  return (
    <div className="min-h-screen bg-brand-dark">
      <div className="max-w-lg mx-auto px-4 py-10">
        {/* Back */}
        <Link href="/" className="inline-flex items-center gap-2 text-brand-muted text-sm hover:text-brand-white mb-8 transition-colors">
        ...
        <div className="mb-6">
          <div className="flex items-start justify-between">
            <div>
              <h1 className="font-display text-4xl text-brand-white tracking-wider">TRACKING</h1>
              <p className="text-brand-green font-display text-xl tracking-wider mt-0.5">{order.order_number}</p>
            </div>
        ...
        <div className="mt-6 bg-brand-card border border-brand-border rounded-2xl p-5 space-y-3">
          ...
          {order.order_type === 'delivery' && order.delivery_line1 && (
            <div className="flex items-start gap-3">
              <MapPin className="w-4 h-4 text-brand-muted flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-brand-muted text-xs uppercase tracking-widest">Delivery to</p>
                <p className="text-brand-white text-sm">{order.delivery_line1}, {order.delivery_city} {order.delivery_postcode}</p>
              </div>
            </div>
          )}
          ...
          {order.order_type === 'collection' && (
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-brand-white text-sm">{BRAND.address}</p>
              </div>
            </div>
          )}
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 w-full mt-4 py-3 rounded-xl border border-brand-border text-brand-muted text-sm hover:border-brand-green/30 hover:text-brand-white transition-colors"
        >
